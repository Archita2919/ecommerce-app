        ...
        <View className='mb-6'>
          ...
          >
            {BANNERS.map((banner, index) => (
              <View key={index} className='relative w-full h-48
            bg-gray-200 overflow-hidden' style={{
                  width: width
                    - 32
                }}>
                ...
                <View className='absolute bottom-4 left-4 z-10'>
                  ...
                  <TouchableOpacity className='mt-2 bg-white 
                px-4 py-2 rounded-full self-start'>
